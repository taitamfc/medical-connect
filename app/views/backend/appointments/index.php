<div class="wrap">
    ...
    <ul class="subsubsub">
        ...
        <li class="publish"><a href="<?= MCAppHelpper::getCurrentUrl();?>&status=pending"><?= mc_lang('Pending');?></a> |</li>
        <li class="publish"><a href="<?= MCAppHelpper::getCurrentUrl();?>&status=approved"><?= mc_lang('Approved');?></a> |</li>
        <li class="publish"><a href="<?= MCAppHelpper::getCurrentUrl();?>&status=done"><?= mc_lang('Done');?></a></li>
    </ul>
    <form id="posts-filter" method="get">
        <input type="hidden" name="page" value="<?= MC_PLUGIN_BACKEND_URL;?>">
        <input type="hidden" name="paged" value="<?= $paged; ?>">
        <p class="search-box">
            <label class="screen-reader-text" for="post-search-input"><?= mc_lang('Search appointments');?>:</label>
            <input type="search" id="post-search-input" name="s" value="<?= $s; ?>">
            <input type="submit" id="search-submit" class="button" value="<?= mc_lang('Search appointments');?>">
        </p>
